...
EXPECTED_API_OPERATIONS = {
    ...
    ("GET", "/api/projects/{project_id}/directory"),
    ("GET", "/api/projects/{project_id}/file-search"),
    ("GET", "/api/projects/{project_id}/file-preview"),
    ("GET", "/api/projects/{project_id}/file-inline"),
    ("GET", "/api/projects/{project_id}/file-download"),
    ("GET", "/api/projects/{project_id}/entry-info"),
    ("GET", "/api/projects/{project_id}/content-summary"),
    ("GET", "/api/projects/{project_id}/export"),
    ("POST", "/api/projects/{project_id}/folders"),
    ("POST", "/api/projects/{project_id}/files"),
    ("PUT", "/api/projects/{project_id}/files"),
    ("DELETE", "/api/projects/{project_id}/entries"),
